	...
	private void createInstance() {
		...
		if (this.waterArms != null) {
			...
			if (this.arm.equals(Arm.LEFT)) {
				if (this.waterArms.isLeftArmCooldown() || this.nPlayer.isOnCooldown("WaterArms_LEFT")) {
					return;
				} else {
			...
			if (this.arm.equals(Arm.RIGHT)) {
				if (this.waterArms.isRightArmCooldown() || this.nPlayer.isOnCooldown("WaterArms_RIGHT")) {
					return;
				} else {
					if (this.usageCooldownEnabled) {
