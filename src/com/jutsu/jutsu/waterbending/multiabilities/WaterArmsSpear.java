	...
	private void createInstance() {
		...
		if (this.waterArms != null) {
			...
			if (this.arm.equals(Arm.LEFT)) {
				if (this.waterArms.isLeftArmCooldown() || this.nPlayer.isOnCooldown("WaterArms_LEFT") || !this.waterArms.displayLeftArm()) {
					return;
				} else {
					if (this.usageCooldownEnabled) {
						this.nPlayer.addCooldown("WaterArms_LEFT", this.usageCooldown);
					}
			...
			if (this.arm.equals(Arm.RIGHT)) {
				if (this.waterArms.isRightArmCooldown() || this.nPlayer.isOnCooldown("WaterArms_RIGHT") || !this.waterArms.displayRightArm()) {
					return;
				} else {
					if (this.usageCooldownEnabled) {
						this.nPlayer.addCooldown("WaterArms_RIGHT", this.usageCooldown);
					}
