...
public class SurgeWave extends WaterAbility {
	...
	public void moveWater() {
		if (this.nPlayer.isOnCooldown("SurgeWave")) {
			return;
		}
		this.nPlayer.addCooldown("SurgeWave", this.cooldown);
	...
	public boolean prepare() {
		this.cancelPrevious();
		final Block block = BlockSource.getWaterSourceBlock(this.player, this.selectRange, ClickType.SHIFT_DOWN, true, true, this.nPlayer.canPlantbend());
	...
	public void progress() {
		...
		if (System.currentTimeMillis() - this.time >= this.interval) {
			this.time = System.currentTimeMillis();
			if (!this.progressing && !this.nPlayer.getBoundAbilityName().equals(this.getName())) {
				this.remove();
				return;
