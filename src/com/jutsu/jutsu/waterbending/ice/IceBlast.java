...
public class IceBlast extends IceAbility {
	...
	public static void activate(final Player player) {
		...
		if (nPlayer != null && nPlayer.isOnCooldown("IceBlast")) {
			return;
		}
	...
	public void progress() {
		if (!this.nPlayer.canBendIgnoreBinds(this)) {
			this.remove();
			return;
		}
		...
		if (!this.nPlayer.getBoundAbilityName().equalsIgnoreCase(this.getName()) && this.prepared) {
			this.remove();
			return;
		}
