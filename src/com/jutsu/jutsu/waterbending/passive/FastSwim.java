...
public class FastSwim extends WaterAbility implements PassiveAbility {
	...
	public void progress() {
		if (!this.nPlayer.canUsePassive(this) || !this.nPlayer.canBendPassive(this) || CoreAbility.hasAbility(this.player, WaterSpout.class) || CoreAbility.hasAbility(this.player, EarthArmor.class)) {
			this.remove();
			return;
		}
		...
		if (this.nPlayer.getBoundAbility() == null || (this.nPlayer.getBoundAbility() != null && !this.nPlayer.getBoundAbility().isSneakAbility())) {
			if (this.player.isSneaking()) {
				if (isWater(this.player.getLocation().getBlock()) && !this.nPlayer.isOnCooldown(this)) {
