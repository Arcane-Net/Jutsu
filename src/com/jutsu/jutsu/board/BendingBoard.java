...
/**
 * Represents a player's scoreboard for jutsu purposes
 */
public class BendingBoard {
	...
	private final Ninja bendingPlayer;
	...
	public BendingBoard(final Ninja nPlayer) {
		bendingPlayer = nPlayer;
		player = nPlayer.getPlayer();
	...
	private ChatColor getColor(String from, ChatColor def) {
		if (from.equalsIgnoreCase("style")) {
