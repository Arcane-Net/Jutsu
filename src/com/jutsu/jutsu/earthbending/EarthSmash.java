...
public class EarthSmash extends EarthAbility {
	...
	public void setFields() {
		final Ninja nPlayer = Ninja.getBendingPlayer(this.player);
	...
	public void animateLift() {
		if (this.animationCounter < 4) {
			...
			if (this.animationCounter == 0) {
				 ...
				 * location being 1 above the initial jutsu block, however we
				 * want to animate it starting from the original jutsu block.
