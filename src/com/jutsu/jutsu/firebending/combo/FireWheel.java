...
public class FireWheel extends FireAbility implements ComboAbility {
	...
	public FireWheel(final Player player) {
		...
		if (this.nPlayer.isOnCooldown("FireWheel") && !this.nPlayer.isAvatarState()) {
			this.remove();
			return;
		}
	...
	public void progress() {
		if (!this.nPlayer.canBendIgnoreBindsCooldowns(this) || GeneralMethods.isRegionProtectedFromBuild(this.player, this.location)) {
			this.remove();
			return;
		}
