...
public class ComboManager {
	...
	public static void addComboAbility(final Player player, final ClickType type) {
		...
		final String abilityName = nPlayer.getBoundAbilityName();
		if (abilityName == null) {
			return;
		}
		...
		if (comboAbil == null) {
			return;
		} else if (!player.hasPermission("jutsu.ability." + comboAbil.getName())) {
			return;
		}
	...
	/**
	 * Gets all of the combos for a given style.
	 *
	 * @param style The style to get combos for
	 * @return An ArrayList of the combos for that style
	 */
	public static ArrayList<String> getCombosForElement(final Style style) {
