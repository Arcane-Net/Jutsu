...
public interface Ability {
	 ...
	 * as <b>/jutsu display</b> and <b>/jutsu help</b>. For example: Combos,
	...
	/**
	 * The name of the ability is used for commands such as <b>/jutsu
	 * display</b> and <b>/jutsu help</b>. The name is also used for
	 * determining the tag for cooldowns
	 * {@link Ninja#addCooldown(Ability)}, therefore if two abilities
	 ...
	 * cooldowns, then {@link Ninja#addCooldown(String, long)} should be
	 * called explicitly.
	 *
	...
	/**
	 * Specifies the Style used to represent this type of ability, favoring
	 * SubElements over Style. For example, a LightningAbility would return
	 * {@link Style#LIGHTNING} instead of {@link Style#FIRE}.
	 *
	 * @return the most accurate Style that this ability belongs to
