...
public class ConfigManager {
	...
	public static void configCheck(final ConfigType type) {
		...
		if (type == ConfigType.PRESETS) {
			...
			config.addDefault("Commands.Who.Description", "This command will tell you what style all players that are online are (If you don't specify a player) or give you information about the player that you specify.");
			...
			config.addDefault("Commands.Toggle.Description", "This command will toggle a player's own jutsu on or off. If toggled off, all abilities should stop working until it is toggled back on. Logging off will automatically toggle your Bending back on. If you run the command /jutsu toggle all, Bending will be turned off for all players and cannot be turned back on until the command is run again.");
			config.addDefault("Commands.Toggle.ToggledOn", "You have turned your jutsu back on.");
			config.addDefault("Commands.Toggle.ToggledOff", "Your jutsu has been toggled off. You will not be able to use most abilities until you toggle it back.");
			...
			config.addDefault("Commands.Toggle.ToggleOnSingleElement", "You have toggled on your {style}.");
			config.addDefault("Commands.Toggle.ToggleOffSingleElement", "You have toggled off your {style}.");
			config.addDefault("Commands.Toggle.ToggleOnSingleElementPassive", "You have toggled on your {style} Passives.");
			config.addDefault("Commands.Toggle.ToggleOffSingleElementPassive", "You have toggled off your {style} Passives.");
			config.addDefault("Commands.Toggle.WrongElement", "You do not have that style.");
			...
			config.addDefault("Commands.Toggle.Other.ToggledOnElementConfirm", "You've toggled on {target}'s {style}");
			config.addDefault("Commands.Toggle.Other.ToggledOffElementConfirm", "You've toggled off {target}'s {style}");
			config.addDefault("Commands.Toggle.Other.ToggledOnElementByOther", "Your {style} has been toggled on by {sender}.");
			config.addDefault("Commands.Toggle.Other.ToggledOffElementByOther", "Your {style} has been toggled off by {sender}.");
			config.addDefault("Commands.Toggle.Other.PlayerNotFound", "Target is not found.");
			config.addDefault("Commands.Toggle.Other.WrongElement", "{target} doesn't have that style.");
			config.addDefault("Commands.Toggle.Reminder", "Reminder, you toggled your jutsu before signing off. Enable it again with /jutsu toggle.");

			config.addDefault("Commands.Remove.Description", "This command will remove the style of the targeted [Player]. The player will be able to re-pick their style after this command is run on them, assuming their jutsu was not permaremoved.");
			config.addDefault("Commands.Remove.Other.RemovedAllElements", "Your jutsu has been removed by {sender}.");
			config.addDefault("Commands.Remove.Other.RemovedAllElementsConfirm", "You've removed {target}'s jutsu.");
			config.addDefault("Commands.Remove.Other.RemovedElement", "Your {style} has been removed by {sender}.");
			config.addDefault("Commands.Remove.Other.RemovedElementConfirm", "You removed {target}'s {style}.");
			config.addDefault("Commands.Remove.Other.WrongElement", "{target} does not have that style.");
			config.addDefault("Commands.Remove.RemovedElement", "You've removed your {style}.");
			config.addDefault("Commands.Remove.InvalidElement", "That style is invalid!");
			config.addDefault("Commands.Remove.WrongElement", "You do not have that style.");
			config.addDefault("Commands.Remove.PlayerNotFound", "That player has not played before!");

			config.addDefault("Commands.Reload.Description", "This command will reload the jutsu config files.");
			config.addDefault("Commands.Reload.SuccessfullyReloaded", "Bending Config reloaded!");

			config.addDefault("Commands.Preset.Description", "This command manages Presets, which are saved bindings. Use /jutsu preset list to view your existing presets, use /jutsu [create|delete] [name] to manage your presets, and use /jutsu bind [name] to bind an existing preset.");
			...
			config.addDefault("Commands.Preset.Removed", "Your jutsu has been permanently removed.");
			config.addDefault("Commands.Preset.RemovedConfirm", "You have permanently removed {target}'s jutsu.");
			...
			config.addDefault("Commands.Preset.FailedToBindAll", "Some abilities were not bound because you cannot bend the required style.");
			...
			config.addDefault("Commands.Preset.BendingPermanentlyRemoved", "Your jutsu was permanently removed.");
			...
			config.addDefault("Commands.Preset.Other.BendingPermanentlyRemoved", "That player's jutsu was permanently removed.");
			...
			config.addDefault("Commands.PermaRemove.Description", "This command will permanently remove the jutsu of the targeted <Player>. Once removed, a player may only receive jutsu again if this command is run on them again. This command is typically reserved for administrators.");
			config.addDefault("Commands.PermaRemove.InvalidPlayer", "That player could not be found.");
			config.addDefault("Commands.PermaRemove.Restored", "Your jutsu has been restored.");
			config.addDefault("Commands.PermaRemove.RestoredConfirm", "You have restored the jutsu of {target}.");
			config.addDefault("Commands.PermaRemove.Removed", "Your jutsu has been permanently removed.");
			config.addDefault("Commands.PermaRemove.RemovedConfirm", "You have removed the jutsu of {target}.");

			config.addDefault("Commands.Invincible.Description", "This command will make you immune to all jutsu damage. Once you use this command, you will stay invincible until you log off or use this command again.");
			config.addDefault("Commands.Invincible.ToggledOn", "You are now invincible to all jutsu damage and effects. Use this command again to disable this.");
			config.addDefault("Commands.Invincible.ToggledOff", "You are no longer invincible to all jutsu damage and effects.");
			...
			config.addDefault("Commands.Help.Style.LearnMore", "Learn more at our website! ");
			config.addDefault("Commands.Help.InvalidTopic", "That isn't a valid help topic. Use /jutsu help for more information.");
			config.addDefault("Commands.Help.Usage", "Usage: ");

			config.addDefault("Commands.Display.Description", "This command will show you all of the styles you have bound if you do not specify an style. If you do specify an style (Air, Water, Earth, Fire, or Chi), it will show you all of the available abilities of that style installed on the server.");

			config.addDefault("Commands.Display.NoCombosAvailable", "There are no {style} combos available.");
			config.addDefault("Commands.Display.NoPassivesAvailable", "There are no {style} passives available.");
			config.addDefault("Commands.Display.NoAbilitiesAvailable", "There are no {style} abilities on this server.");
			...
			config.addDefault("Commands.Display.NoBinds", "You do not have any abilities bound.\nIf you would like to see a list of available abilities, please use the /jutsu display [Style] command. Use /jutsu help for more information.");
			...
			config.addDefault("Commands.Board.Description", "Toggle jutsu board visibility.");
			config.addDefault("Commands.Board.Disabled", "Bending board is disabled.");
			config.addDefault("Commands.Board.ToggledOn", "You have made your jutsu board visible again.");
			config.addDefault("Commands.Board.ToggledOff", "You have hidden your jutsu board.");
			...
			config.addDefault("Commands.Choose.Description", "This command will allow the user to choose a single style for themselves or <Player> if specified. This command can only be used once per player unless they have permission to rechoose their style.");
			config.addDefault("Commands.Choose.InvalidElement", "That is not a valid style.");
			config.addDefault("Commands.Choose.PlayerNotFound", "Could not find player.");
			config.addDefault("Commands.Choose.OnCooldown", "You must wait %cooldown% before changing your style.");
			config.addDefault("Commands.Choose.SuccessfullyChosenCFW", "You are now a {style}.");
			config.addDefault("Commands.Choose.SuccessfullyChosenAE", "You are now an {style}.");
			config.addDefault("Commands.Choose.Other.SuccessfullyChosenCFW", "{target} is now a {style}.");
			config.addDefault("Commands.Choose.Other.SuccessfullyChosenAE", "{target} is now an {style}.");
			...
			config.addDefault("Commands.Bind.ElementToggledOff", "You have that ability's style toggled off currently.");
			config.addDefault("Commands.Bind.SuccessfullyBound", "Succesfully bound {ability} to slot {slot}.");
			config.addDefault("Commands.Bind.NoElement", "You are not a {style}!");
			config.addDefault("Commands.Bind.NoElementAE", "You are not an {style}!");
			...
			config.addDefault("Commands.Add.Description", "This command will allow the user to add an style to the targeted <Player>, or themselves if the target is not specified. This command is typically reserved for server administrators.");
			config.addDefault("Commands.Add.SuccessfullyAddedCFW", "You are now also a {style}.");
			config.addDefault("Commands.Add.SuccessfullyAddedAE", "You are now also an {style}.");
			...
			config.addDefault("Commands.Add.InvalidElement", "You must specify a valid style.");
			config.addDefault("Commands.Add.AlreadyHasElement", "You already have that style!");
			config.addDefault("Commands.Add.AlreadyHasSubElement", "You already have that subelement!");
			config.addDefault("Commands.Add.AlreadyHasAllElements", "You already have all styles!");
			config.addDefault("Commands.Add.Other.SuccessfullyAddedCFW", "{target} is now also a {style}.");
			config.addDefault("Commands.Add.Other.SuccessfullyAddedAE", "{target} is now also an {style}.");
			config.addDefault("Commands.Add.Other.SuccessfullyAddedAll", "{target} now also has: ");
			config.addDefault("Commands.Add.Other.AlreadyHasElement", "{target} already has that style!");
			config.addDefault("Commands.Add.Other.AlreadyHasSubElement", "{target} already has that subelement!");
			config.addDefault("Commands.Add.Other.AlreadyHasAllElements", "{target} already has all styles!");
			...
			config.addDefault("Commands.Help.Style.Air", "Air is the style of freedom. Airbenders are natural pacifists and great explorers. There is nothing stopping them from scaling the tallest mountains and walls easily. They specialize in redirection, from blasting things away with gusts of winds, to forming a shield around them to prevent damage. Easy to get across flat terrains, such as oceans, there is practically no terrain off limits to Airbenders. They lack much raw damage output, but make up for it with with their ridiculous amounts of utility and speed.\nEnter /b display Air for a list of the available air abilities.");
			config.addDefault("Abilities.Air.AirBlast.Description", "AirBlast is the most fundamental jutsu technique of an airbender. It allows the bender to be extremely agile and possess great mobility, but also has many utility options, such as cooling lava, opening doors and flicking levers.");
			...
			config.addDefault("Commands.Help.Style.Water", "Water is the style of change. Waterbending focuses on using your opponents own force against them. Using redirection and various dodging tactics, you can be made practically untouchable by an opponent. Waterbending provides agility, along with strong offensive skills while in or near water.\nEnter /b display Water for a list of the available water abilities.");
			config.addDefault("Abilities.Water.Bloodbending.Description", "Bloodbending is one of the most unique jutsu abilities that existed and it has immense power, which is why it was made illegal in the Avatar universe. People who are capable of bloodbending are immune to your technique, and you are immune to theirs.");
...
//			config.addDefault("Abilities.Water.PlantTether.DeathMessage", "{victim} was constricted by {attacker}'s {ability}");
			...
			config.addDefault("Commands.Help.Style.Fire", "Fire is the style of power. Firebenders focus on destruction and incineration. Their abilities are pretty straight forward: set things on fire. They do have a bit of utility however, being able to make themselves un-ignitable, extinguish large areas, cook food in their hands, extinguish large areas, small bursts of flight, and then comes the abilities to shoot fire from your hands.\nEnter /b display Fire for a list of the available fire abilities.");
			...
			config.addDefault("Abilities.Fire.FireBlast.Description", "FireBlast is the most fundamental jutsu technique of a firebender. It allows the firebender to create mass amounts of fire blasts to constantly keep damaging an entity. It's great for rapid fire successions to deal immense damage.");
			...
			config.addDefault("Abilities.Fire.FireShield.Description", "FireShield is a basic defensive ability that allows a firebender to block projectiles or other jutsu abilities. It's useful while fighting off skeletons, or while trying to block jutsu abilities at low health.");
			config.addDefault("Abilities.Fire.FireShield.Instructions", "Hold sneak to create a fire shield around you that will block projectiles and other jutsu abilities. Additionally, left click to create a temporary fire shield. If entities step inside this fire shield, they will be ignited.");
			...
			config.addDefault("Commands.Help.Style.Chi", "Chiblockers focus on bare handed combat, utilizing their agility and speed to stop any bender right in their path. Although they lack the ability to bend any of the other styles, they are great in combat, and a serious threat to any bender. Chiblocking was first shown to be used by Ty Lee in Avatar: The Last Airbender, then later by members of the Equalists in The Legend of Korra.\nEnter /b display Chi for a list of the available chi abilities.");
			...
			config.addDefault("Commands.Help.Style.Avatar", "Avatars are the human embodiment of light and peace created through a connection with the Avatar Spirit. It is considered an Avatar's duty to master the four styles and use that power to keep balance among the four nations as well as act as the bridge between the physical and spiritual worlds.\nEnter /b display Avatar for a list of the available avatar abilities.");
			...
			config.addDefault("Properties.RegionProtection.Residence.Flag", "jutsu");
