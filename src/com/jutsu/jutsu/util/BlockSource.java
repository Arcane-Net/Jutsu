...
/**
 * BlockSource is a class that handles water and earth jutsu sources. When a
...
public class BlockSource {
	/**
	 * An enum representation of the source types available for jutsu
	 * abilities.
	 *
	 * @author kingbirdy
	 */
	 ...
	 *
	 * @param player the player performing the jutsu.
	 ...
	 * @param range the maximum jutsu range.
