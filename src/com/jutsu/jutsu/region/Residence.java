...
class Residence extends RegionProtectionBase {
    ...
    protected Residence() {
        ...
        this.flag = ConfigManager.defaultConfig.get().getString("Properties.RegionProtection.Residence.Flag", "jutsu");
        if (this.flag.equals("")) this.flag = "jutsu";
    ...
    public boolean isRegionProtectedReal(Player player, Location location, CoreAbility ability, boolean harmless, boolean igniteAbility, boolean explosiveAbility) {
        ...
        if (claim != null) {
            ...
            //If the jutsu flag is turned off
