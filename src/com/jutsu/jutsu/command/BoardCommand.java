...
/**
 * Executor for /jutsu board. Extends {@link PKCommand}.
 */
public class BoardCommand extends PKCommand {

	public BoardCommand() {
		super("board", "/jutsu board", ConfigManager.languageConfig.get().getString("Commands.Board.Description"), new String[]{ "bendingboard", "board", "bb" });
	}
