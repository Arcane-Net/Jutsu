...
/**
 * Executor for /jutsu debug. Extends {@link PKCommand}.
 */
public class DebugCommand extends PKCommand {

	public DebugCommand() {
		super("debug", "/jutsu debug", ConfigManager.languageConfig.get().getString("Commands.Debug.Description"), new String[] { "debug", "de" });
	}
	...
	/**
	 * Checks if the CommandSender has the permission 'jutsu.admin.debug'. If
	...
	public boolean hasPermission(final CommandSender sender) {
		if (!sender.hasPermission("jutsu.admin." + this.getName())) {
